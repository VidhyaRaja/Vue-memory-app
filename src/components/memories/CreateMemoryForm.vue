...
<script>
import { IonList, IonItem, IonLabel, IonInput, IonIcon,
IonTextarea, IonButton, IonThumbnail} from '@ionic/vue';
import { camera } from 'ionicons/icons';
import { Camera, CameraResultType } from '@capacitor/camera';

export default {
    emits:['save-memory'],
    components: {IonList, IonItem, IonLabel, IonInput, IonIcon,
    IonTextarea, IonButton, IonThumbnail},
    data(){
        return {
            enteredTitle: '',
            enteredDescription:'',
